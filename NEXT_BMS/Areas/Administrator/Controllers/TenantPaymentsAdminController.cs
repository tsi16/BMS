...
namespace NEXT_BMS.Areas.Administrator.Controllers
{
    ...
    public class TenantPaymentsAdminController : Controller
    {
        private readonly NEXT_BMSContext _context;

        public TenantPaymentsAdminController(NEXT_BMSContext context)
        {
            _context = context;
        }
        public IActionResult Index(int? id)
        {
            ...
            var tenants = _context.Tenants
                ...
                .Include(x => x.TenantUsers).ThenInclude(x=>x.User).ThenInclude(x=>x.MaintenanceRequests)
