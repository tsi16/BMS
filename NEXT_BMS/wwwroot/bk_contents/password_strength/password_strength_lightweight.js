...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        //this.element.append('<input type="password" id="Password" name="Password" class="' + options.inputClass + '"/>');
        this.element.append(`<div class="input-group">
											<input type="password" id="Password" name="Password" class="${options.inputClass}" placeholder="******">
                                             <input type="text" class="${ options.inputClass}" style="display:none" placeholder="******"/>
                                            <a class="btn btn-light ${options.toggleButtonClass}" type="button">${options.showPasswordText}</a>
										</div>`);
